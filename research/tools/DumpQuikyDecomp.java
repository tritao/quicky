    ...
    private String[][] targetsFor(String segment) {
        ...
        if ("SEG03".equals(segment)) {
            return new String[][] {
                ...
                {"1e04", "stream_are_object_records"},
                ...
                // Focused W1L1 session closure: the pickup dispatch wrappers
                // publish sprite/callback/subtype state before 8D20.
                {"8bc2", "init_pickup_type_6f"},
                {"8be5", "init_pickup_type_70"},
                {"8c08", "init_pickup_type_71"},
                {"8c2b", "init_pickup_type_72"},
                ...
                {"474d", "initialize_falling_leaf_state"},
                {"47e7", "update_falling_leaf"},
