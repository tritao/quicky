    ...
    private String[][] targetsFor(String segment) {
        ...
        if ("SEG03".equals(segment)) {
            return new String[][] {
                ...
                {"5c27", "map_descriptor_quadrant_probe"},
                {"5cc3", "map_descriptor_read"},
                ...
                {"393c", "compute_player_collision_bounds"},
                ...
                {"8d20", "update_are_type_2c"},
                {"8d31", "update_are_type_2c_action_helper"},
