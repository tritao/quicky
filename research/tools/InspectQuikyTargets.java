...
public class InspectQuikyTargets extends GhidraScript {
    ...
    public void run() throws Exception {
        ...
        scanImmediateReferences(new int[] {0x612e, 0x819e, 0x8806, 0x8808, 0x880a, 0x880c, 0x881a, 0x881c, 0x8822, 0x8824, 0x8828, 0x882a, 0x89e6});
        if (program.contains("SEG01")) {
            ...
            inspectData(new int[] {0x612e, 0x6986, 0x6d86, 0x819e, 0x8806, 0x8808, 0x880a, 0x880c, 0x881a, 0x881c, 0x8822, 0x8824, 0x8828, 0x882a, 0x89e6});
        }
    }
