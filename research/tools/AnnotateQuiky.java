...
public class AnnotateQuiky extends GhidraScript {
    ...
    private void annotateSegment3() throws Exception {
        ...
        function(0xf21c, "player_action_input_helper_f21c",
            "Relocation target reached immediately after the DS:656C player-action read; return value supplies the normalized action word used by the player callback.");
