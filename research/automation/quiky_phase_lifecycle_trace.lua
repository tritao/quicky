...
local function teardown_probe_hits()
    ...
    local targets = {
        ...
        {segment = 0x01f7, offset = 0xb84d, name = "b84d_transition_init"},
        {segment = 0x1997, offset = 0xb84d, name = "b84d_transition_init"},
        {segment = 0x01f7, offset = 0xb87b, name = "b87b_transition"},
        {segment = 0x1997, offset = 0xb87b, name = "b87b_transition"},
        {segment = 0x01f7, offset = 0xb89f, name = "b87b_callback_clear"},
        {segment = 0x1997, offset = 0xb89f, name = "b87b_callback_clear"},
