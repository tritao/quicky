...
class QuikyCtlTests(unittest.TestCase):
    ...
    def test_entity_catalog_and_record_variant_cover_confirmed_2b(self):
        ...
        for entity_type, name in (
            ...
            (0x0B, "snow_variant_0b"),
            (0x0C, "snow_variant_0c"),
        ...
        for entity_type, descriptor in (
            (0x6F, (185, 8140, (26, 34), (0, 0))),
            (0x70, (186, 8184, (21, 22), (0, 0))),
            (0x71, (187, 8228, (22, 22), (0, 0))),
            (0x72, (144, 6336, (15, 25), (0, 0))),
            ...
            (0x07, (97, 4268, (41, 21), (20, 21))),
            (0x09, (116, 5104, (36, 35), (18, 35))),
            (0x15, (125, 5500, (37, 30), (18, 30))),
            (0x17, (110, 4840, (36, 29), (18, 29))),
            (0x19, (110, 4840, (33, 27), (16, 27))),
            (0x1B, (138, 6072, (31, 31), (15, 31))),
            (0x2C, (135, 5940, (18, 15), (0, 0))),
